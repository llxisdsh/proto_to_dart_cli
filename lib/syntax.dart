...
import 'package:cli/json_ast/json_ast.dart' show Node;
...
class TypeDefinition {
  ...
  TypeDefinition(this.name, {this.subtype, this.isAmbiguous = false, Node? astNode}) {
    if (subtype == null) {
      ...
      if (name == 'int' && isASTLiteralDouble(astNode)) {
        name = 'double';
      } /*else if (name == 'String' && isASTLiteralDateTime(astNode)) {
        name = 'DateTime';
      }*/
    } else {
      _isPrimitive = isPrimitiveType('$name<$subtype>');
      /*if (subtype == 'String' && isASTLiteralDateTimeList(astNode)) {
        subtype = 'DateTime';
      }*/
    }
  }
  ...
  bool operator ==(other) {
    if (other is TypeDefinition) {
      ...
      return name == otherTypeDef.name && subtype == otherTypeDef.subtype && isAmbiguous == otherTypeDef.isAmbiguous && _isPrimitive == otherTypeDef._isPrimitive;
    }
    return false;
  }
